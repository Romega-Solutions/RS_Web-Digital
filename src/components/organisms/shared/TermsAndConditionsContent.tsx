  ...
  return (
    <div className="prose prose-sm max-w-none">
      ...
      <p className="text-gray-700 mb-4">
        ...
        www.romega-solutions.com and any related platforms, services, or tools
      ...
      <ul className="list-disc pl-6 text-gray-700 mb-4">
        <li className="mb-2">The information is accurate, current, and complete.</li>
        <li className="mb-2">You have the right to share such information with us.</li>
        <li className="mb-2">
